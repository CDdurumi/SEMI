        ...
        <nav class="nav">
            <div> <a href="/goIndex.board" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">쉼표
                ...
                <div class="nav_list">
                    ...
                    <a href="/editorReMain.board?" class="nav_link"> <i class='bx bx-book-bookmark nav_icon'></i> <span class="nav_name">에디터추천</span>
                    </a>
...
// 			alert("바꾼 후 : "+option);
	...
	// 				$("#fileArea").prepend('<div id="profileDiv"><input type="file" name="file0" id="profile" required><i>-> 프로필 사진</i><br></div>');				
		...
		$('.summernote').summernote({
			placeholder:"자유롭게 글을 작성할 수 있습니다.<br/>명예훼손이나 상대방을 비방, 불쾌감을 주는 글, 욕설, 남을 모욕하는 글은 임의로 제재가 있을 수 있습니다.",
            toolbar: [
							['style', ['style']],
							['fontsize', ['fontsize']],
