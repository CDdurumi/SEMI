...
<body id="body-pd">
    <header class="header" id="header" style="background-color:#f5f5f7">
        <div class="header_toggle"><i class='bx bx-menu' id="header-toggle"></i></div>
         <div><a href="/communityMain.board" class="comuview">모두에게 편안한 밤을 </a></div>
        <div>
            <c:choose>
    ...
    <ul class="nav nav2">
        ...
        <li class="nav-item">
            <a class="nav-link nav-link2" href="/houseMain.board?cpage=1" id="page">숙소리뷰</a>
        </li>
    </ul>
        ...
        <nav class="nav">
            <div> <a href="/goIndex.board" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">쉼표
                ...
                <div class="nav_list">
                   ...
                   <a href="/houseMain.board?cpage=1" class="nav_link active1"> <i class='bx bx-home nav_icon'></i> <span class="nav_name">숙소리뷰</span> </a>
               		<c:choose>
						<c:when test="${loginID !=null}">
                    ...
                    <div class="col-12" id="carousel">
						<div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
							...
							<div class="carousel-indicators">
								...
								<c:forEach var="i" items="${hotlist}" varStatus="status">
									<c:if test="${status.index lt fn:length(hotlist)-1}">
										<button type="button"
...
<div class="col-12" id="searchbar" >
    <nav class="navbar bg">
        ...
        <form action="/search.board" method="post" class="d-flex" role="search">
          		<input type="hidden" value="h" name="boardOption">
        ...
        <div class="row m-0 ">
            <div class="col-12 ">
                <div class="row " id="board_menu_text">
                    ...
                    <div class="col-7 col-md-5 title">제목</div>
 ...
 <button onclick="topFunction()" id="myBtn" title="Go to top">↑</button>
    ...
    <script>
		...
		$("#cancel").on("click",function(){
			location.href = "/houseMain.board?cpage=1"; 
		});
     ...
     // input id, input pw, password eyes
        ...
        $("#writeBtn").on("click",function(){
        	location.href="/writeboard.board?boardOption=h";
        })
    </script>
