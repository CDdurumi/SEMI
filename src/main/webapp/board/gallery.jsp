        ...
        <div> <a href="/index.jsp" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">쉼표
            ...
            <div class="nav_list">
               <a href="#" class="nav_link"> <i class='CurrIcon'></i> <span class="nav_name"><span class="weather">
                ...
                <a href="/board/editorReMain.jsp" class="nav_link active"> <i class='bx bx-book-bookmark nav_icon'></i> <span class="nav_name">에디터추천</span>
                </a>
        ...
        <c:forEach var="i" items="${list}">
        	<c:forEach var="j" items="${porfileList}">
				<c:if test="${j.parent_seq eq i.all_board_seq}">
					<div class="col-12 col-sm-6 col-md-3" id="img"><img src="${profilePath}${j.sys_name}" alt=".." class="rounded-circle w-100 h-100" style="box-shadow: 5px 5px 5px 5px gray"><div class="mask"><p1>${i.title}</p1></div></div>
				</c:if>
        	</c:forEach>
        </c:forEach>
        </div>
